...
cm_scores_file =  'checkpoint_cm_score.txt'

# Replace ASV scores with organizers' scores or provide score file as the second argument.
asv_score_file = 'E:\POST\DeepFakeAudio\DATASETLER\ASV2019\LA\ASVspoof2019_LA_asv_scores\ASVspoof2019.LA.asv.eval.gi.trl.scores.txt'
