# -*- coding: utf-8 -*-
"""
Created on Mon Aug  5 21:32:16 2024
...
if __name__ == '__main__':
    ...
    parser.add_argument('--database_path', type=str, default='E:/POST/DeepFakeAudio/DATASETLER/ASV2019/LA/', help='change this to user\'s full directory address of LA database')
    parser.add_argument('--protocols_path', type=str, default='E:/POST/DeepFakeAudio/DATASETLER/ASV2019/LA/ASVspoof2019_LA_cm_protocols/', help='Change with path to user\'s LA database protocols directory address')
    parser.add_argument('--eval_output', type=str, default='checkpoint_cm_score2.txt',help='Path to save the evaluation result')
    ...
    track = args.track
    #Creat Model
    model_tag = 'model3_{}_{}_{}_{}_{}'.format(
    ...
    if args.eval:
        modelyolu='E:/2_UNIFI/MODELS/rawnet2-SE/rawnet2-antispoofing-main/models/model3_logical_weighted_CCE_100_16_0.0001/epoch_30.pth'
        model.load_state_dict(torch.load(modelyolu,map_location=device))
        produce_evaluation_file(dev_set, model, device, args.eval_output)
        sys.exit(0)
    # Dataloader
    train_set = data_utils_LA.ASVDataset(database_path=args.database_path,protocols_path=args.protocols_path,is_train=True, is_logical=is_logical, transform=transforms,feature_name=args.features)
